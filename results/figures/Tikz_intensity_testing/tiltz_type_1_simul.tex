...
\draw[blue,thin]
(axis cs:1,0.047) -- (axis cs:1.1,0.050);

\node[
blue,
font=\small,
anchor=south west
] at (axis cs:1.05,0.046) {0.047};
...
\draw[orange,thin]
(axis cs:2,0.058) -- (axis cs:2.08,0.075);

\node[
orange,
font=\small,
anchor=south west
] at (axis cs:2.05,0.070) {0.058};
...
(axis cs:3,0.062) -- (axis cs:3.07,0.075);

\node[
green!50!black,
font=\small,
anchor=south west
] at (axis cs:3.05,0.067) {0.062};
...
\draw[purple,thin]
(axis cs:4,0.021) -- (axis cs:4.07,0.036);

\node[
purple,
font=\small,
anchor=south west
] at (axis cs:4.05,0.027) {0.021};
