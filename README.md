...
├── simulations/             # Simulation experiments: 1.Torus, 2.Two Circles, 3.ORBIT5K
├── Per_Image_testing/       # Two-stage test based on persistence images, Moon and Lazaer, 2023
├── Tikz_intensity_testing/  # Latex code for figures used in the paper
